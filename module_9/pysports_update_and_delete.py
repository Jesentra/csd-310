...
def show_players(cursor, title): # New to me, not sure how this works yet. Seems to store commands as an Alias.
...
try:
    ...
    db.commit() # I read that MySQL autocommits inserts. Do we need this?
